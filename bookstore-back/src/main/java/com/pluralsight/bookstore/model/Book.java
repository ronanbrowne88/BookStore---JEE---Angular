...
@Entity
@ApiModel(description = "Book data model")
public class Book {
    ...
    @Column(length = 200) @NotNull @Size(min = 2 , max = 200)
    @ApiModelProperty("title of the book")
    private String title;

    @Column(length = 10000)  @Size(min = 2 , max = 10000)
    @ApiModelProperty("description of the book")
    private String description;

    @Column(name = "unit_cost") @NotNull @Min(1)
    @ApiModelProperty("cost of the book")
    private Float unitCost;

    @Column(length = 50) @NotNull  @Size(min = 2 , max = 50)
    @ApiModelProperty("ISBN of the book")
    private String isbn;

    @Column(name = "publication_date") @Past
    @Temporal(TemporalType.DATE)
    @ApiModelProperty("publication of the book")
    private Date publicationDate;

    @Column(name = "nb_of_pages")
    @ApiModelProperty("number of the books")
